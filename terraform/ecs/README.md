...
| <a name="input_cache_endpoint_read"></a> [cache\_endpoint\_read](#input\_cache\_endpoint\_read) | The endpoint of the cache (read) |  <pre lang="json">string</pre> |  <pre lang="json">n/a</pre> |  yes |
| <a name="input_cache_endpoint_write"></a> [cache\_endpoint\_write](#input\_cache\_endpoint\_write) | The endpoint of the cache (write) |  <pre lang="json">string</pre> |  <pre lang="json">n/a</pre> |  yes |
